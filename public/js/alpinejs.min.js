...
(() => {
    ...
    function M(e, t, r) {
        ...
        let i = n.get(r);
        i || n.set(r, i = new Set),
        i.has(L) || (i.add(L), L.deps.push(i), L.options.onTrack && L.options.onTrack({
            effect: L,
            target: e,
            type: t,
            key: r
    ...
    d("model", (e, {modifiers: t, expression: r}, {effect: n, cleanup: i}) => {
        ...
        let u = e.tagName.toLowerCase() === "select" || ["checkbox", "radio"].includes(e.type) || t.includes("lazy") ? "change" : "input",
            p = I ? () => {} : ae(e, u, t, h => {
                l(Kt(e, t, h, c()))
            });
